...
<body>
  ...
  <h1>P.P.S. complete and updated ebooks are in my calibre library <a href='https://github.com/Cheerstoast/calibre'>here</a>, this project will <em>not</em> be maintained actively, while the calibre library would have updates once in a while, and has more metadata... </h1>
  </div>
  <ul>
<?php
